// Client-side copy of the defaults. Must stay in sync with server/src/services/prompts.js
// (it's duplicated so the Settings panel can "Reset to defaults" without a round trip).
...
const KEY_KEY = "twinmind.groqKey.v1";
